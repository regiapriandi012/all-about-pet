    ...
    <div class="body">
            ...
            <nav id="main-navbar" class="navbar navbar-default navbar-fixed-top" role="navigation" style="background:#315D7C">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a href="{{ url('/indexadmin') }}') }}"><img src="assets/img/logo2.png" width=140px; height=50px; style="margin-top: 10px;"></a>
                    </div>
            ...
            <div class="container">
                <div class="caption text-center text-white" data-stellar-ratio="0.7">
                    <div id="owl-intro-text" class="owl-carousel">
                        <a class="btn btn-blank tombolutama page-scroll" href="#1-section" role="button" style="background-color: #315D7C !important">Admin Action</a>
                    </div>
                </div>
            </div>
        </section>
        <section id="1-section" class="page text-center">
            <div class="page-header-wrapper">
                <div class="container">
                    <div class="page-header text-center wow fadeInDown">
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="rotate-box-info">
                                <h4>{{$data->title}}</h4>
                                <p>Writen by: {{$data->author}}</p><br>
                                <form action="{{ route('destroy.tipsmerawathewan',['id'=>$data->id]) }}" method="POST">
                                    @method('DELETE') @csrf
                                    <a class="btn btn-blank" href="{{ route('edit.tipsmerawathewan',['id' => $data->id]) }}" role="button" style="background-color: #315D7C !important">Edit Artikel</a>
                                    <input type="submit" class="btn btn-blank" value="Hapus Artikel" role="button" style="background-color: #315D7C !important; border-radius:6px !important;">
                                </form>
                            </div>
                            </a>
                            <br><br><br>
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="rotate-box-info">
                                <h4>{{$data->title}}</h4>
                                <p>Writen by: {{$data->author}}</p><br>
                                <form action="{{ route('destroy.tipsmerawatkandang',['id'=>$data->id]) }}" method="POST">
                                    @method('DELETE') @csrf
                                    <a class="btn btn-blank" href="{{ route('edit.tipsmerawatkandang',['id' => $data->id]) }}" role="button" style="background-color: #315D7C !important">Edit Artikel</a>
                                    <input type="submit" class="btn btn-blank" value="Hapus Artikel" role="button" style="background-color: #315D7C !important; border-radius:6px !important;">
                            </div>
                            </a>
                            <br><br><br>
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="rotate-box-info">
                                <h4>{{$data->title}}</h4>
                                <p>Writen by: {{$data->author}}</p><br>
                                <form action="{{ route('destroy.tipsmengatasihewansakit',['id'=>$data->id]) }}" method="POST">
                                    @method('DELETE') @csrf
                                    <a class="btn btn-blank" href="{{ route('edit.tipsmengatasihewansakit',['id' => $data->id]) }}" role="button" style="background-color: #315D7C !important">Edit Artikel</a>
                                    <input type="submit" class="btn btn-blank" value="Hapus Artikel" role="button" style="background-color: #315D7C !important; border-radius:6px !important;">
                            </div>
                            </a>
                            <br><br><br>
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="rotate-box-info">
                                <h4>{{$data->title}}</h4>
                                <p>Writen by: {{$data->author}}</p><br>
                                <form action="{{ route('destroy.rekomendasimakanan',['id'=>$data->id]) }}" method="POST">
                                    @method('DELETE') @csrf
                                    <a class="btn btn-blank" href="{{ route('edit.rekomendasimakanan',['id' => $data->id]) }}" role="button" style="background-color: #315D7C !important">Edit Artikel</a>
                                    <input type="submit" class="btn btn-blank" value="Hapus Artikel" role="button" style="background-color: #315D7C !important; border-radius:6px !important;">
                            </div>
                            </a>
                            <br><br><br>
                        ...
                        <div class="row">
                            <div class="col-sm">
                                <div class="rotate-box-info">
                                    <h4>{{$data->title}}</h4>
                                    <p>Writen by: {{$data->author}}</p><br>
                                    <form action="{{ route('destroy.rekomendasivitamin',['id'=>$data->id]) }}" method="POST">
                                        @method('DELETE') @csrf
                                        <a class="btn btn-blank" href="{{ route('edit.rekomendasivitamin',['id' => $data->id]) }}" role="button" style="background-color: #315D7C !important">Edit Artikel</a>
                                        <input type="submit" class="btn btn-blank" value="Hapus Artikel" role="button" style="background-color: #315D7C !important; border-radius:6px !important;">
                                </div>
                                </a>
                                <br><br><br>
                        ...
                        <div class="row">
                            <div class="col-sm">
                                <div class="rotate-box-info">
                                    <h4>{{$data->title}}</h4>
                                    <p>Writen by: {{$data->author}}</p><br>
                                    <form action="{{ route('destroy.informasivaksin',['id'=>$data->id]) }}" method="POST">
                                        @method('DELETE') @csrf
                                        <a class="btn btn-blank" href="{{ route('edit.informasivaksin',['id' => $data->id]) }}" role="button" style="background-color: #315D7C !important">Edit Artikel</a>
                                        <input type="submit" class="btn btn-blank" value="Hapus Artikel" role="button" style="background-color: #315D7C !important; border-radius:6px !important;">
                                </div>
                                </a>
                                <br><br><br>
